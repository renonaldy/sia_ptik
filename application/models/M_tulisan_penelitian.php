<?php
class M_tulisan_penelitian extends CI_Model{

	function get_all_tulisan_penelitian(){
	...
	function get_all_tulisan_penelitian_kirim(){
	...
	function simpan_tulisan_penelitian($judul,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug){
		$hsl=$this->db->query("insert into tbl_penelitian(penelitian_judul,penelitian_isi,penelitian_kategori_id,penelitian_kategori_nama,penelitian_pengguna_id,penelitian_author,penelitian_gambar,penelitian_slug,penelitian_status) values ('$judul','$isi','$kategori_id','$kategori_nama','$user_id','$user_nama','$gambar','$slug','1')");
		return $hsl;
	}
	function get_tulisan_penelitian_by_kode($kode){
	...
	function update_tulisan_penelitian($penelitian_id,$judul,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug){
		$hsl=$this->db->query("update tbl_penelitian set penelitian_judul='$judul',penelitian_isi='$isi',penelitian_kategori_id='$kategori_id',penelitian_kategori_nama='$kategori_nama',penelitian_pengguna_id='$user_id',penelitian_author='$user_nama',penelitian_gambar='$gambar',penelitian_slug='$slug',penelitian_status='1' where penelitian_id='$penelitian_id'");
		return $hsl;
	}
	function update_tulisan_penelitian_tanpa_img($penelitian_id,$judul,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$slug){
		$hsl=$this->db->query("update tbl_penelitian set penelitian_judul='$judul',penelitian_isi='$isi',penelitian_kategori_id='$kategori_id',penelitian_kategori_nama='$kategori_nama',penelitian_pengguna_id='$user_id',penelitian_author='$user_nama',penelitian_slug='$slug',penelitian_status='1' where penelitian_id='$penelitian_id'");
		return $hsl;
	}
	function hapus_tulisan_penelitian($kode){
	...
	function get_tulisan_by_kategori($kategori_id){
		$hsl=$this->db->query("SELECT tbl_penelitian.*,DATE_FORMAT(penelitian_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_penelitian where penelitian_kategori_id='$kategori_id'");
		return $hsl;
	}

	function get_tulisan_by_kategori_perpage($kategori_id,$offset,$limit){
		$hsl=$this->db->query("SELECT tbl_penelitian.*,DATE_FORMAT(penelitian_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_penelitian where penelitian_kategori_id='$kategori_id' limit $offset,$limit");
		return $hsl;
	}
    ...
    function count_good($kode){
        ...
        if($cek_ip->num_rows() <= 0){
            $this->db->trans_start();
				...
				$this->db->query("UPDATE tbl_penelitian SET penelitian_rating=penelitian_rating+1 where penelitian_id='$kode'");
			$this->db->trans_complete();
			if($this->db->trans_status()==TRUE){
				return TRUE;
			}else{
    ...
    function count_like($kode){
        ...
        if($cek_ip->num_rows() <= 0){
            $this->db->trans_start();
				...
				$this->db->query("UPDATE tbl_penelitian SET penelitian_rating=penelitian_rating+2 where penelitian_id='$kode'");
			$this->db->trans_complete();
			if($this->db->trans_status()==TRUE){
				return TRUE;
			}else{
    ...
    function count_love($kode){
        ...
        if($cek_ip->num_rows() <= 0){
            $this->db->trans_start();
				...
				$this->db->query("UPDATE tbl_penelitian SET penelitian_rating=penelitian_rating+3 where penelitian_id='$kode'");
			$this->db->trans_complete();
			if($this->db->trans_status()==TRUE){
				return TRUE;
			}else{
    ...
    function count_genius($kode){
        ...
        if($cek_ip->num_rows() <= 0){
            $this->db->trans_start();
				...
				$this->db->query("UPDATE tbl_penelitian SET penelitian_rating=penelitian_rating+4 where penelitian_id='$kode'");
			$this->db->trans_complete();
			if($this->db->trans_status()==TRUE){
				return TRUE;
			}else{
    ...
    function get_tulisan_populer(){
		$hasil=$this->db->query("SELECT tbl_penelitian.*,DATE_FORMAT(penelitian_tanggal,'%d %M %Y') AS tanggal FROM tbl_penelitian ORDER BY penelitian_views DESC limit 10");
		return $hasil;
	}
	...
	function get_kategori_for_blog(){
		$hasil=$this->db->query("SELECT COUNT(penelitian_kategori_id) AS jml,kategori_id,kategori_nama FROM tbl_penelitian JOIN tbl_kategori ON penelitian_kategori_id=kategori_id GROUP BY penelitian_kategori_id");
		return $hasil;
	}
