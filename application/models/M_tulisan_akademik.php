<?php
class M_tulisan_akademik extends CI_Model{

	function get_all_tulisan_akademik(){
	...
	function get_all_tulisan_akademik_kirim(){
	...
	function simpan_tulisan_akademik($judul,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug){
		$hsl=$this->db->query("insert into tbl_akademik(akademik_judul,akademik_isi,akademik_kategori_id,akademik_kategori_nama,akademik_pengguna_id,akademik_author,akademik_gambar,akademik_slug,akademik_status) values ('$judul','$isi','$kategori_id','$kategori_nama','$user_id','$user_nama','$gambar','$slug','1')");
		return $hsl;
	}
	function get_tulisan_akademik_by_kode($kode){
	...
	function update_tulisan_akademik($akademik_id,$judul,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug){
