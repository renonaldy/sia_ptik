...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jul 2022 pada 08.27
...
CREATE TABLE `tbl_administrasi` (
  ...
  `administrasi_judul` varchar(200) NOT NULL,
  `administrasi_isi` text NOT NULL,
  `administrasi_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `administrasi_kategori_id` int(11) NOT NULL,
  `administrasi_kategori_nama` varchar(200) NOT NULL,
  `administrasi_views` int(50) NOT NULL,
  `administrasi_gambar` varchar(500) NOT NULL,
  `administrasi_pengguna_id` int(11) NOT NULL,
  `administrasi_author` varchar(200) NOT NULL,
  `administrasi_img_slider` int(11) NOT NULL,
  `administrasi_slug` varchar(500) NOT NULL,
  `administrasi_rating` int(50) NOT NULL,
  `administrasi_status` char(11) NOT NULL
...
INSERT INTO `tbl_administrasi` (`administrasi_id`, `administrasi_judul`, `administrasi_isi`, `administrasi_tanggal`, `administrasi_kategori_id`, `administrasi_kategori_nama`, `administrasi_views`, `administrasi_gambar`, `administrasi_pengguna_id`, `administrasi_author`, `administrasi_img_slider`, `administrasi_slug`, `administrasi_rating`, `administrasi_status`) VALUES
(1, 'Renonaldy', '<p>Pendaftaran pelatihan microsoft</p>\r\n', '2022-07-08 17:19:55', 1, 'Data Wisudawan', 0, '3bff8dd00e8444fd0439713514ef25fd.jpg', 1, 'Administrator', 0, 'renonaldy.html', 0, '1'),
(2, 'Reno', '<p>asdasda</p>\r\n', '2022-07-06 21:06:44', 2, 'Data Seminar Proposal', 0, '2f987622e0920dd12348374e2efd9b5f.jpg', 1, 'Administrator', 0, 'reno.html', 0, '1');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_administrasi_kategori`
--

CREATE TABLE `tbl_administrasi_kategori` (
  `kategori_administrasi_id` int(11) NOT NULL,
  `kategori_administrasi_nama` varchar(200) NOT NULL,
  `kategori_administrasi_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_akademik` (
  ...
  `akademik_judul` varchar(200) DEFAULT NULL,
  `akademik_isi` text DEFAULT NULL,
  `akademik_tanggal` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `akademik_kategori_id` int(11) DEFAULT NULL,
  `akademik_kategori_nama` varchar(200) DEFAULT NULL,
  `akademik_views` int(50) DEFAULT NULL,
  `akademik_gambar` varchar(500) DEFAULT NULL,
  `akademik_pengguna_id` int(11) DEFAULT NULL,
  `akademik_author` varchar(200) DEFAULT NULL,
  `akademik_img_slider` int(2) NOT NULL,
  `akademik_slug` varchar(500) DEFAULT NULL,
  `akademik_rating` int(50) DEFAULT NULL,
  `akademik_status` char(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_akademik` (`akademik_id`, `akademik_judul`, `akademik_isi`, `akademik_tanggal`, `akademik_kategori_id`, `akademik_kategori_nama`, `akademik_views`, `akademik_gambar`, `akademik_pengguna_id`, `akademik_author`, `akademik_img_slider`, `akademik_slug`, `akademik_rating`, `akademik_status`) VALUES
(2, 'Kegiatan HMMPS PTIK', '<p>Fungsi dari setting custom error adalah, ketika ada error dalam halaman maka otomatis akan mengarahkan ke halaman error 404. Untuk setting custom error handler pada&nbsp;<code>E_NOTICE&nbsp;</code>dan meredirect pesan dari pesan default.&nbsp;Menonaktifkan error notice berfungsi untuk mengurangi notifikasi error pada halaman yang dibuat. Untuk menonaktifkan error notice pada variabel error PHP Anda bisa melakukan setting di file&nbsp;<code>php.ini</code>&nbsp;dengan mengubah bagian&nbsp;<code>display_error : off</code>&nbsp;bisa juga menggunakan function&nbsp;<code>error_reporting(error_reporting() &amp; ~E_NOTICE</code>) .&nbsp;</p>\r\n\r\n<p>Anda Juga dapat melewatkan beberapa error pada PHP dengan menggunakan syntak @operator. Untuk melewatkan error pada variabel PHP Anda bisa menambahkan kode berikut:</p>\r\n\r\n<pre>\r\n<code>echo &quot;variabel saya adalah: &quot;. @$nama_variable;</code></pre>\r\n\r\n<pre>\r\n<code>echo &quot;index value adalah: &quot;. @$array_contoh[&quot;nama_index&quot;];</code></pre>\r\n', '2022-07-01 13:00:34', 1, 'Laporan PLP', NULL, '2b8fc65f71ea0b9fae2f3bbdc9612046.jpg', 1, 'Administrator', 0, 'kegiatan-hmmps-ptik.html', NULL, '1'),
(3, 'Reno', '<p>hahahhaha bodoh</p>\r\n', '2022-07-01 19:02:14', 17, 'Laporan KKN', NULL, 'bbfd3304f45ed31a540d9a33dd93c9b4.jpg', 1, 'Administrator', 0, 'reno.html', NULL, '1'),
(6, 'Juara 1 Lomba ', '<p>Juara 1&nbsp;</p>\r\n', '2022-07-06 21:06:14', 16, 'Prestasi Non Akademik', NULL, 'c30812dcd9892802ccad30cbab80c19e.jpg', 1, 'Administrator', 0, 'juara-1-lomba-.html', NULL, '1');
...
(6, 'Lomba Logo Desain', '2022-07-01 20:25:31', 1, 'Administrator', 0, 'a3c38e87ce64d273076e1660f384234d.jpg');
...
CREATE TABLE `tbl_alumni` (
  ...
  `alumni_judul` varchar(200) NOT NULL,
  `alumni_isi` text NOT NULL,
  `alumni_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `alumni_kategori_id` int(11) NOT NULL,
  `alumni_kategori_nama` varchar(200) NOT NULL,
  `alumni_views` int(50) NOT NULL,
  `alumni_gambar` varchar(400) NOT NULL,
  `alumni_pengguna_id` int(11) NOT NULL,
  `alumni_author` varchar(200) NOT NULL,
  `alumni_img_slider` int(2) NOT NULL,
  `alumni_slug` varchar(400) NOT NULL,
  `alumni_slider` int(50) NOT NULL,
  `alumni_status` char(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_alumni` (`alumni_id`, `alumni_judul`, `alumni_isi`, `alumni_tanggal`, `alumni_kategori_id`, `alumni_kategori_nama`, `alumni_views`, `alumni_gambar`, `alumni_pengguna_id`, `alumni_author`, `alumni_img_slider`, `alumni_slug`, `alumni_slider`, `alumni_status`) VALUES
(1, 'Pengembangan Media Pembelajaran', '<p>as</p>\r\n', '2022-07-06 21:07:22', 2, 'Penelitian Kuantitatif', 0, 'aef2ed58a52af78c0ca45e7e1950d3a3.jpg', 1, 'Administrator', 0, 'pengembangan-media-pembelajaran.html', 0, '1');
...
CREATE TABLE `tbl_dosen` (
  ...
  `dosen_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Struktur dari tabel `tbl_inbox_administrasi`
--

CREATE TABLE `tbl_inbox_administrasi` (
  `administrasi_inbox_id` int(11) NOT NULL,
  `administrasi_inbox_nama` varchar(400) NOT NULL,
  `administrasi_inbox_email` varchar(400) NOT NULL,
  `administrasi_inbox_kontak` varchar(100) NOT NULL,
  `administrasi_inbox_pesan` text NOT NULL,
  `administrasi_inbox_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `administrasi_inbox_status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_inbox_akademik`
--

CREATE TABLE `tbl_inbox_akademik` (
  `akademik_inbox_id` int(11) NOT NULL,
  `akademik_inbox_nama` varchar(400) NOT NULL,
  `akademik_inbox_email` varchar(400) NOT NULL,
  `akademik_inbox_kontak` varchar(100) NOT NULL,
  `akademik_inbox_pesan` text NOT NULL,
  `akademik_inbox_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `akademik_inbox_status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_jabatan` (
  ...
  `jabatan_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_jabatan` (`jabatan_id`, `jabatan_nama`, `jabatan_tanggal`) VALUES
(3, 'Asisten Ahli', '2022-07-02 09:38:06'),
(4, 'Lektor (200 kum)', '2022-07-02 09:38:37'),
(5, 'Lektor (300 kum)', '2022-07-02 09:38:51'),
(6, 'Lektor Kepala (400 kum)', '2022-07-02 09:39:00'),
(7, 'Lektor Kepala (550 kum)', '2022-07-02 09:39:14'),
(8, 'Lektor Kepala (700 kum)', '2022-07-02 09:39:28'),
(9, 'Profesor (850 kum)', '2022-07-02 09:39:38'),
(10, 'Profesor (1050 kum)', '2022-07-02 09:39:48');
...
--
-- Struktur dari tabel `tbl_kategori_administrasi`
--

CREATE TABLE `tbl_kategori_administrasi` (
  `kategori_administrasi_id` int(11) NOT NULL,
  `kategori_administrasi_nama` varchar(400) NOT NULL,
  `kategori_administrasi_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbl_kategori_administrasi`
--

INSERT INTO `tbl_kategori_administrasi` (`kategori_administrasi_id`, `kategori_administrasi_nama`, `kategori_administrasi_tanggal`) VALUES
(1, 'Data Wisudawan', '2022-07-01 20:03:57'),
(2, 'Data Seminar Proposal', '2022-07-01 20:04:13'),
(5, 'Pelatihan Microsoft', '2022-07-06 21:51:38');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_kategori_akademik`
--

CREATE TABLE `tbl_kategori_akademik` (
  `kategori_akademik_id` int(11) NOT NULL,
  `kategori_akademik_nama` varchar(500) NOT NULL,
  `kategori_akademik_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbl_kategori_akademik`
--

INSERT INTO `tbl_kategori_akademik` (`kategori_akademik_id`, `kategori_akademik_nama`, `kategori_akademik_tanggal`) VALUES
(15, 'Prestasi Akademik', '2022-07-01 18:40:36'),
(16, 'Prestasi Non Akademik', '2022-07-01 18:40:43'),
(17, 'Laporan KKN', '2022-07-01 18:40:52'),
(18, 'Laporan Prakerin', '2022-07-01 18:40:58');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_kategori_alumni`
--

CREATE TABLE `tbl_kategori_alumni` (
  `kategori_alumni_id` int(11) NOT NULL,
  `kategori_alumni_nama` varchar(200) NOT NULL,
  `kategori_alumni_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbl_kategori_alumni`
--

INSERT INTO `tbl_kategori_alumni` (`kategori_alumni_id`, `kategori_alumni_nama`, `kategori_alumni_tanggal`) VALUES
(2, 'Penelitian Kuantitatif', '2022-07-03 09:42:46'),
(3, 'Penelitian Kualitatif', '2022-07-03 09:42:53'),
(4, 'Penelitian Pengembangan', '2022-07-03 09:43:00'),
(5, 'Penelitian Perancangan', '2022-07-03 09:43:05');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_kategori_penelitian`
--

CREATE TABLE `tbl_kategori_penelitian` (
  `kategori_penelitian_id` int(11) NOT NULL,
  `kategori_penelitian_nama` varchar(400) NOT NULL,
  `kategori_penelitian_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbl_kategori_penelitian`
--

INSERT INTO `tbl_kategori_penelitian` (`kategori_penelitian_id`, `kategori_penelitian_nama`, `kategori_penelitian_tanggal`) VALUES
(1, 'Publikasi Ilmiah', '2022-07-05 16:15:04'),
(2, 'Data Penelitian', '2022-07-05 17:08:08'),
(5, 'Data PKM', '2022-07-06 21:54:43');
...
CREATE TABLE `tbl_pangkat` (
  ...
  `pangkat_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbl_pangkat`
--

INSERT INTO `tbl_pangkat` (`pangkat_id`, `pangkat_nama`, `pangkat_tanggal`) VALUES
(1, 'Penata Muda Gol. III/a', '2022-07-02 09:46:37'),
(2, 'Penata Muda Tk. I Gol  III/b', '2022-07-02 09:47:04'),
(3, 'Penata Gol. III/c', '2022-07-02 09:47:18'),
(4, 'Penata Tk. I Gol III/d', '2022-07-02 09:47:40'),
(5, 'Pembina Gol. IV/a', '2022-07-02 09:48:04'),
(6, 'Pembina Tk. I Gol IV/b', '2022-07-02 09:48:22'),
(7, 'Pembina Utama Muda Gol. IV/c', '2022-07-02 09:48:39'),
(8, 'Pembina Utama Madya Gol. IV/d', '2022-07-02 09:48:57'),
(9, 'Pembina Utama Gol. IV/e', '2022-07-02 09:49:12');
...
CREATE TABLE `tbl_penelitian` (
  ...
  `penelitian_judul` varchar(200) NOT NULL,
  `penelitian_isi` text NOT NULL,
  `penelitian_tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `penelitian_kategori_id` int(11) NOT NULL,
  `penelitian_kategori_nama` varchar(200) NOT NULL,
  `penelitian_views` int(50) NOT NULL,
  `penelitian_gambar` varchar(500) NOT NULL,
  `penelitian_pengguna_id` int(11) NOT NULL,
  `penelitian_author` varchar(200) NOT NULL,
  `penelitian_img_slider` int(2) NOT NULL,
  `penelitian_slug` varchar(500) NOT NULL,
  `penelitian_rating` int(50) NOT NULL,
  `penelitian_status` char(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_penelitian` (`penelitian_id`, `penelitian_judul`, `penelitian_isi`, `penelitian_tanggal`, `penelitian_kategori_id`, `penelitian_kategori_nama`, `penelitian_views`, `penelitian_gambar`, `penelitian_pengguna_id`, `penelitian_author`, `penelitian_img_slider`, `penelitian_slug`, `penelitian_rating`, `penelitian_status`) VALUES
(3, 'Pengembangan E-Modul Simulasi Digital', '<p>Modul Pembelajaran E-lektronik Pada Mata Kuliah Simulasi Digital</p>\r\n\r\n<p>&nbsp;</p>\r\n', '2022-07-06 21:04:05', 1, 'Publikasi Ilmiah', 0, 'af7eb677e3716222b8cdb841b2c39037.jpg', 1, 'Administrator', 0, 'pengembangan-e-modul-simulasi-digital.html', 0, '1'),
(4, 'Pengembangan Modul Elektronik', '<p>Modul berbasis elektronik</p>\r\n', '2022-07-08 18:42:09', 2, 'Data Penelitian', 0, '54a797f232fddcd41049092f2bb9d41c.jpg', 1, 'Administrator', 0, 'pengembangan-modul-elektronik.html', 0, '1');
...
(1, 'Administrator', 'Just do it', 'L', 'admin', '21232f297a57a5a743894a0e4a801fc3', '-', 'admin@gmail.com', '081273136130', 'facebook.com', 'twitter.com', '', '', 1, '1', '2016-09-03 06:07:55', 'b50d40c501a43ebc6f373a219dc2b854.jpg');
...
CREATE TABLE `tbl_tulisan` (
  ...
  `tulisan_gambar` mediumtext DEFAULT NULL,
...
(8, '1810013231009', 'Renonaldy Pratama Diasno', 'konyetnyet28@gmail.com', '1eb02016a9d78a6c2f1e69229152db77'),
(9, '1810013231005', 'Hafizh Hidayat Ramedief', 'hafizhidayat88@gmail.com', 'a00163e00203850e59ccbd5cb3ec7dee');
...
--
-- Indeks untuk tabel `tbl_administrasi_kategori`
--
ALTER TABLE `tbl_administrasi_kategori`
  ADD PRIMARY KEY (`kategori_administrasi_id`);
...
--
-- Indeks untuk tabel `tbl_inbox_administrasi`
--
ALTER TABLE `tbl_inbox_administrasi`
  ADD PRIMARY KEY (`administrasi_inbox_id`);

--
-- Indeks untuk tabel `tbl_inbox_akademik`
--
ALTER TABLE `tbl_inbox_akademik`
  ADD PRIMARY KEY (`akademik_inbox_id`);
...
--
-- Indeks untuk tabel `tbl_kategori_administrasi`
--
ALTER TABLE `tbl_kategori_administrasi`
  ADD PRIMARY KEY (`kategori_administrasi_id`);

--
-- Indeks untuk tabel `tbl_kategori_akademik`
--
ALTER TABLE `tbl_kategori_akademik`
  ADD PRIMARY KEY (`kategori_akademik_id`);

--
-- Indeks untuk tabel `tbl_kategori_alumni`
--
ALTER TABLE `tbl_kategori_alumni`
  ADD PRIMARY KEY (`kategori_alumni_id`);

--
-- Indeks untuk tabel `tbl_kategori_penelitian`
--
ALTER TABLE `tbl_kategori_penelitian`
  ADD PRIMARY KEY (`kategori_penelitian_id`);
...
--
-- Indeks untuk tabel `tbl_pangkat`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_administrasi_kategori`
--
ALTER TABLE `tbl_administrasi_kategori`
  MODIFY `kategori_administrasi_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_inbox_administrasi`
--
ALTER TABLE `tbl_inbox_administrasi`
  MODIFY `administrasi_inbox_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_inbox_akademik`
--
ALTER TABLE `tbl_inbox_akademik`
  MODIFY `akademik_inbox_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_kategori_administrasi`
--
ALTER TABLE `tbl_kategori_administrasi`
  MODIFY `kategori_administrasi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `tbl_kategori_akademik`
--
ALTER TABLE `tbl_kategori_akademik`
  MODIFY `kategori_akademik_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT untuk tabel `tbl_kategori_alumni`
--
ALTER TABLE `tbl_kategori_alumni`
  MODIFY `kategori_alumni_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `tbl_kategori_penelitian`
--
ALTER TABLE `tbl_kategori_penelitian`
  MODIFY `kategori_penelitian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_pangkat`
--
ALTER TABLE `tbl_pangkat`
  MODIFY `pangkat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_tulisan`
  MODIFY `tulisan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
