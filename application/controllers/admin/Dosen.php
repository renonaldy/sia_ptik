...
class Dosen extends CI_Controller{
	function __construct(){
		...
		$this->load->model('m_tulisan_dosen');
	...
	function simpan_dosen(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_tulisan_dosen->simpan_dosen($nama_dosen,$nidn,$nik,$jenis_kelamin,$jabatan,$pangkat,$no_sertifikasi,$user_id,$user_nama,$gambar,$photo);
