                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $akademik_isi=$i['akademik_isi'];
          					   $akademik_tanggal=$i['tanggal'];
          					   $akademik_author=$i['akademik_author'];
          					   $akademik_gambar=$i['akademik_gambar'];
          					   $akademik_views=$i['akademik_views'];
                       $kategori_akademik_id=$i['akademik_kategori_id'];
                       $kategori_akademik_nama=$i['akademik_kategori_nama'];
                       
                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/akademik/'.$tulisan_gambar;?>" style="width:90px;"></td>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/akademik/get_edit/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
