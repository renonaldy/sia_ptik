    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Judul Penelitian</h3>
        </div>
		
		<form action="<?php echo base_url().'admin/alumni/simpan_alumni'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Deskripsi Penelitian</h3>
            </div>
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="xkategori" style="width: 100%;" required>
				  ...
				  <?php
                    ...
                    ?>
                  <option value="<?php echo $kategori_alumni_id;?>"><?php echo $kategori_alumni_nama;?></option>
				  <?php endforeach;?>
                </select>
              </div>
