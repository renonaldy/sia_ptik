  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'admin/akademik/simpan_akademik'?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="xkategori" style="width: 100%;" required>
				  ...
				  <?php
                    ...
                    ?>
                  <option value="<?php echo $kategori_akademik_id;?>"><?php echo $kategori_akademik_nama;?></option>
				  <?php endforeach;?>
                </select>
              </div>
